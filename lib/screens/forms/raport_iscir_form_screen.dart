...
class _RaportIscirFormScreenState extends State<RaportIscirFormScreen> with TickerProviderStateMixin {
  int _currentPage = 0;
  ...
  void initState() {
    ...
    ).animate(CurvedAnimation(parent: _buttonAnimationController, curve: Curves.easeOutBack));
  ...
  String get _currentPageTitle {
    switch (_currentPage) {
      case 0: return 'Identificare & Echipament';
      case 1: return 'Verificare Documente';
      case 2: return 'Verificări Funcționale';
      case 3: return 'Analiză Gaze Arse';
      case 4: return 'Concluzii & Semnături';
      default: return 'Pagina ${_currentPage + 1}';
    }
  }

  String get _currentPageSubtitle {
    switch (_currentPage) {
      case 0: return 'Date client și instalație de ardere';
      case 1: return 'Documentație și lucrări efectuate';
      case 2: return 'Verificări la rece și la cald';
      case 3: return 'Măsurători gaze de ardere';
      case 4: return 'Rezultate și autorizări finale';
      default: return 'Completează informațiile necesare';
    }
  }
              ...
              child: PageView(
                ...
                children: [
                  RaportIscirPage1(
                    ...
                    form: widget.form,
                    controllers: _page1Controllers,
                    checkboxes: _page1Checkboxes,
                    radioSelections: _page1RadioSelections,
                    onDataChanged: () => _autoSavePage1(),
                  ),
                  RaportIscirPage2(
                    client: widget.client,
                    form: widget.form,
                    controllers: _page2Controllers,
                    checkboxes: _page2Checkboxes,
                    tripleRadioSelections: _page2RadioSelections,
                    onDataChanged: () => _autoSavePage2(),
                  ),
                  RaportIscirPage3(
                    client: widget.client,
                    form: widget.form,
                    controllers: _page3Controllers,
                    checkboxes: _page3Checkboxes,
                    tripleRadioSelections: _page3RadioSelections,
                    onDataChanged: () => _autoSavePage3(),
                  ),
                  RaportIscirPage4(
                    client: widget.client,
                    form: widget.form,
                    controllers: _page4Controllers,
                    checkboxes: _page4Checkboxes,
                    tripleRadioSelections: _page4RadioSelections,
                    onDataChanged: () => _autoSavePage4(),
                  ),
                  RaportIscirPage5(
                    client: widget.client,
                    form: widget.form,
                    controllers: _page5Controllers,
                    checkboxes: _page5Checkboxes,
                    tripleRadioSelections: _page5RadioSelections,
                    signatures: _page5Signatures,
                    onDataChanged: () => _autoSavePage5(),
                    onSignatureChanged: _onPage5SignatureChanged,
                  ),
                ],
              ),
            ),
